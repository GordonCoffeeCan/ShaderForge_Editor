...
Shader "CVR_VFX_Shaders/Water_Shader"
{
	Properties
	{
		...
		_NormalTiles("NormalTiles", Range( 0 , 5)) = 0.3
		_NormalStrength("Normal Strength", Range( 0 , 1)) = 1
		_NormalSpeed("Normal Speed", Range( 0 , 10)) = 1
		_Smoothness("Smoothness", Range( 0 , 1)) = 0.85
		_SeaFoam("Sea Foam", 2D) = "white" {}
		_SeaFoamTile("Sea Foam Tile", Range( 0 , 10)) = 1
		_EdgeFoamTile("Edge Foam Tile", Range( 0 , 5)) = 2
		_EdgePower("Edge Power", Range( 0 , 1)) = 0.5
		_EdgeDistance("Edge Distance", Range( 0 , 5)) = 0.3
		...
		_Tesselation("Tesselation", Range( 0 , 50)) = 8
		_TesselationMaxDistance("Tesselation Max Distance", Float) = 80
	...
	SubShader
	{
		...
		uniform float _TesselationMaxDistance;
		...
		{
			float4 Tesselation142 = UnityDistanceBasedTess( v0.vertex, v1.vertex, v2.vertex, 0.0,_TesselationMaxDistance,( _WaveHeight * _Tesselation ));
		...
		{
			float temp_output_180_0 = ( _NormalSpeed / 100.0 );
			float3 ase_worldPos = i.worldPos;
			float4 appendResult10 = (float4(ase_worldPos.x , ase_worldPos.z , 0.0 , 0.0));
			float4 WorldSpaceTile11 = appendResult10;
			float4 temp_output_68_0 = ( ( WorldSpaceTile11 / 10.0 ) * _NormalTiles );
			float2 panner72 = ( 1.0 * _Time.y * ( float2( 1,0 ) * temp_output_180_0 ) + temp_output_68_0.xy);
			float2 panner73 = ( 1.0 * _Time.y * ( float2( -1,0 ) * ( temp_output_180_0 * 1.0 ) ) + ( temp_output_68_0 * ( _NormalTiles * 5.0 ) ).xy);
...
/*ASEBEGIN
Version=17500
7;1087;1906;1014;4759.801;1099.708;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;85;-2630.673,-2597.947;Inherit;False;2539.854;1244.464;Comment;22;73;80;79;72;78;71;69;77;65;75;70;74;66;44;68;67;82;83;84;106;107;180;Normal Map;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-2128.796,-2501.981;Inherit;True;Property;_NormalSpeed;Normal Speed;5;0;Create;True;0;0;False;0;1;5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;180;-1793.123,-2177.198;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-2579.332,-1977.567;Inherit;True;Property;_NormalTiles;NormalTiles;3;0;Create;True;0;0;False;0;0.3;0.3;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;74;-1815.609,-2542.947;Inherit;False;Constant;_PanDirecton1;Pan Directon 1;11;0;Create;True;0;0;False;0;1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;79;-1610.143,-2005.399;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;65;-2172.9,-2040.835;Inherit;True;Property;_NormalMap;Normal Map;2;0;Create;True;0;0;False;0;None;2436eefe9bac89847a312f910cfc3a8c;True;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-2266.922,1736.603;Inherit;True;Property;_SeaFoamTile;Sea Foam Tile;8;0;Create;True;0;0;False;0;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2388.492,178.7425;Inherit;True;Property;_EdgeDistance;Edge Distance;11;0;Create;True;0;0;False;0;0.3;0.3;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-1859.602,-403.2638;Inherit;True;Property;_RefractAmount;Refract Amount;17;0;Create;True;0;0;False;0;0.3;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;-1576.273,-1049.298;Inherit;True;Property;_WaterDepth;Water Depth;18;0;Create;True;0;0;False;0;15;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-4240.188,-566.765;Inherit;False;Property;_Tesselation;Tesselation;19;0;Create;True;0;0;False;0;8;0.01;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-4214.438,-339.0124;Inherit;False;Property;_TesselationMaxDistance;Tesselation Max Distance;20;0;Create;True;0;0;False;0;80;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=28EAA52ED3C828217EC0C07903ABAD85CF401E63