...
////// Lighting:
////// Emissive:
                float4 node_693 = _Time;
                float2 node_3926 = (i.uv0+node_693.g*float2(0,0.1));
                float4 _node_5610_var = tex2D(_node_5610,TRANSFORM_TEX(node_3926, _node_5610));
                float2 node_117 = (i.uv0+node_693.g*float2(0,0.1));
                float4 _node_5610_copy_var = tex2D(_node_5610_copy,TRANSFORM_TEX(node_117, _node_5610_copy));
                float2 node_2906 = ((_node_9463*(_node_5610_var.r+_node_5610_copy_var.r))+(i.uv0+node_693.g*float2(0,0.1)));
